...
public class HelloApplication extends Application {
    ...
    private void initializeData() {
        system.addAirplane(new Airplane(20000, 900, 35, "Бомбардувальник"));
        system.addAirplane(new Airplane(10000, 1200, 15, "Винищувач"));
        system.addAirplane(new Airplane(15000, 800, 20, "Штурмовик"));
    }
